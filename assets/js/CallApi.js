...
async function SearchUniversity() {
  ...
  if (search == null) {
    let response = await fetch(
      `http://localhost:5086/api/University/SearchUniversityMajor?search=${department}`
    );
    let data = await response.json();
    ...
    let response = await fetch(
      `http://localhost:5086/api/University/SearchUniversity?search=${search}`
    );
    let data = await response.json();
...
async function GetInformationUniversity() {
  ...
  let response = await fetch(
    `http://localhost:5086/api/University/gethUniversityById?Id=${search}`
  );
  let data = await response.json();
  if (data.result == null) {
  ...
  localStorage.setItem("IdUniversity", data.id);
...
async function GetAdmissionsMethodsByIdUniversity() {
  ...
  let response = await fetch(
    `http://localhost:5086/api/AdmissionsMethod/GetByIdUniversity?Id=${search}`
  );
  let data = await response.json();
  if (data.result == null) {
    window.location.href = "index.html";
...
async function GetOnlyDepartment() {
  ...
  let response = await fetch(
    `http://localhost:5086/api/Departments/OnlyName?IdUniversity=${IdUniversity}`
  );
  let data = await response.json();
...
async function GetDepartment() {
  ...
  let response = await fetch(
    `http://localhost:5086/api/Departments/GetByIdUniversity?Id=${IdUniversity}`
  );
  let data = await response.json();
...
async function GetPoint() {
  ...
  let response = await fetch(
    `http://localhost:5086/api/Benchmark/Display?IdUniversity=${IdUniversity}&Year=${currentYear}`
  );
  let data = await response.json();
...
async function GetDataArea() {
  ...
  let response = await fetch(
    `http://localhost:5086/api/University/SearchArea?Id=${IdUniversity}`
  );
  let data = await response.json();
...
async function GetAllDepartmentMajor() {
  ...
  let response = await fetch(
    `http://localhost:5086/api/Departments/GetAllDepartmentMajor`
  );
  let data = await response.json();
...
async function GetInformationUniversity1() {
  const nameUniversity = document.getElementById("nameUniversity");
  const list_unstyled = document.getElementById("list-unstyled");

  const search = localStorage.getItem("IdUniversity");
...
async function GetAdmissionsMethodsByIdUniversity1() {
  const AdmissionsMethod = document.getElementById("AdmissionsMethod");
  const search = localStorage.getItem("IdUniversity");
...
async function GetDepartment1() {
  const IdUniversity = localStorage.getItem("IdUniversity");
...
async function GetInformationUniversity2() {
  const nameUniversity = document.getElementById("nameUniversity");
...
function SearchUniversityInformation() {
  var input = document
    .getElementById("search_university")
    .value.trim()
    .toLowerCase();

  if (input.includes("giới thiệu")) {
    window.location.href = `../page/intro.html`;
  } else if (input.includes("tuyển sinh")) {
    window.location.href = `../page/tuyensinh_major.html`;
  } else if (input.includes("ngành")) {
    window.location.href = `../page/method.html`;
  } else if (input.includes("điểm")) {
    window.location.href = `../page/score.html`;
  } else {
    var googleSearchUrl = `https://www.google.com/search?q=${encodeURIComponent(
      input
    )}`;
